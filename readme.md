...
이미지·영상 생성 모델을 호출하여 결과를 시각화합니다.  

>  목표: 비전문가도 AI 모델을 직접 다루지 않고, 텍스트만으로  
> 자연스러운 영상 콘텐츠를 생성할 수 있는 자동화 플랫폼을 만드는 것
...
AI Models	Stable Diffusion XL, WAN2.1 VACE 1.3B, DALL·E 3
Prompt Engine	LangChain, OpenAI API (ChatGPT-4)
Data Handling	SQLAlchemy (SQLite)
